...
<body>
  <div class="login-container">
    ...
    <form action="#" method="post" name="loginForm" id="loginForm" onsubmit="return redirectUser()">
    ...
    <p style="text-align: center; background-color: rgba(54, 137, 131, 0.5);">Don't have an account? <a href="views/signUp.php">Register here</a></p>
  </div>
</body>
